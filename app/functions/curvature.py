...
def curvatures_and_derivatives(mesh):
    (VertexNormals, Avertex, Acorner, up, vp) = calcvertex_normals(mesh, mesh.face_normals)
    (FaceSFM, VertexSFM, wfp) = compute_curvature(mesh, VertexNormals, mesh.face_normals, Avertex, Acorner, up, vp)
    [PrincipalCurvature, PrincipalDi1, PrincipalDi2] = principal_curvatures(mesh, VertexSFM, up, vp)
