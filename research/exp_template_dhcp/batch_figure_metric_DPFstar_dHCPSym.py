...
def main():
    ...
    root_folder = r"E:/research_dpfstar/result_dhcpSym/cortical_metrics_dpfstar"
    ...
    metrics = ['DPFstar_Mean', 'DPFstar_Median', 'DPFstar_Min', 'DPFstar_5p']
    ...
    for metric in metrics:
        ...
        ymin = -all_values[metric].max()
        ymax = -all_values[metric].min()
