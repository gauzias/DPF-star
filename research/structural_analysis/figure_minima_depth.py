...
# === Paramètres ===
csv_path = "E:/research_dpfstar/results_rel3_dhcp/minima_count/minima_summary.csv"
...
fig_path = os.path.join(output_folder, "figure_filtered_minima_regression_clean.png")
